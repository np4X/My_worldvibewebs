...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[scale=1, every node/.style={font=\footnotesize}]
    ...
    \draw[very thick]
      (0,1) -- (0.4,1) -- (0.4,0) -- (1,0) -- (1,1) -- (1.4,1) -- (1.4,0)
      -- (2,0) -- (2,1) -- (2.4,1) -- (2.4,0) -- (3,0);
    \node[left] at (0,1) {$V_{in}$};
    \draw[dashed] (0,0.4) -- (3.2,0.4) node[right] {$\langle V\rangle = D V_{in}$};
    \draw[decorate,decoration={brace,amplitude=4pt}] (0,-0.35) -- (0.4,-0.35) node[midway,below=4pt] {$DT_s$};
    \draw[decorate,decoration={brace,amplitude=4pt}] (0.4,-0.35) -- (1,-0.35) node[midway,below=4pt] {$(1-D)T_s$};
  \end{tikzpicture}
...
\begin{figure}[h!]
  \centering
  \begin{tikzpicture}[scale=1, every node/.style={font=\footnotesize}]
    \draw[->] (-0.5,0) -- (3.4,0) node[right] {$t$};
    \draw[->] (0,-0.3) -- (0,2.2) node[above] {$i_L(t)$};
    \draw[very thick,red]
      (0,0.4) -- (0.4,1.6) -- (1,0.4) -- (1.4,1.6) -- (2,0.4) -- (2.4,1.6) -- (3,0.4);
    \draw[dashed] (-0.2,1) -- (3.2,1) node[right] {$I_L$};
    \draw[decorate,decoration={brace,amplitude=4pt,mirror}] (-0.25,0.4) -- (-0.25,1.6) node[midway,left=6pt] {$2\Delta i_L$};
    \draw[decorate,decoration={brace,amplitude=4pt}] (0,-0.2) -- (0.4,-0.2) node[midway,below=4pt] {$DT_s$};
    \draw[decorate,decoration={brace,amplitude=4pt}] (0.4,-0.2) -- (1,-0.2) node[midway,below=4pt] {$(1-D)T_s$};
  \end{tikzpicture}
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[scale=0.85, every node/.style={font=\scriptsize}]
    ...
    \draw[very thick]
      ...
      -- (7.4,3.35) -- (8,3.1);
    \node[below] at (0,0) {$i_L(0)=0$};
    \draw[dashed] (0.4,0) -- (0.4,1.4); \node[below] at (0.4,0) {$DT_s$};
