...
\begin{figure}[h!]
  \centering
  \begin{circuitikz}[scale=0.85, every node/.style={font=\footnotesize}]
    \draw (0,0)
...
\begin{figure}[h!]
  ...
  \begin{circuitikz}[scale=0.75, every node/.style={font=\footnotesize}]
    ...
    \draw (1,3) circle(0.05);
    \draw (2,3) circle(0.05);
    \node[above] at (1.5,3.15) {$D$ (open)};
    \draw (2,3) -- (2,2.3) circle(0.05);
    \node[right] at (2.1,2.3) {$1{-}D$ (closed)};
    \draw (2,2.25) -- (2,0);
    \draw (2,3) -- (2.6,3) to[L, l=$10\,\mathrm{mH}$] (4.3,3) -- (5.2,3);
    \draw (5.2,2.5) rectangle (6.6,3.5);
    \node at (5.9,3) {$V=0$};
...
\begin{figure}[h!]
  \centering
  \begin{circuitikz}[scale=0.75, every node/.style={font=\footnotesize}]
    \draw (0,0) to[V, invert, l=$V_{S}$] (0,3) -- (1.2,3);
    \node[nmos, rotate=-90] (M1) at (2,3) {};
    \draw (1.2,3) -| (M1.S) node[above]{$A$};
    \draw (M1.D) |- (2.8,3) node[above]{$B$};
    \draw (2.8,3) -- (3.2,3);
    \draw (3.2,3) -- (3.2,2.2);
...
\begin{figure}[h!]
  \centering
  \begin{tikzpicture}[scale=1,every node/.style={font=\footnotesize}]
    \draw[->] (-2.3,0) -- (0.4,0) node[right] {$V_{CB}$};
    \draw[->] (0,-0.3) -- (0,2.2) node[above] {$I_{CB}$};
    \draw[very thick,red] (0,0) -- (0,1.8) node[above]{ON};
    \draw[very thick,red] (0,0) -- (-2.2,0) node[left]{OFF};
  \end{tikzpicture}
